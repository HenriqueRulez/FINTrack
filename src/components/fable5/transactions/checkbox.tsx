...
// Cópia adaptada de src/components/transactions/CheckBox.tsx (raiz intocado).
// Checkbox custom com três estados: off / on / mixed.

interface CheckBoxProps {
  state: "off" | "on" | "mixed";
  onClick?: () => void;
  label?: string;
  interactive?: boolean; // false = visual-only <span> (para nesting em botões)
}
