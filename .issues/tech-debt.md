...
| TD-8 | Rate limit em memória não protege o login (single-secret) em serverless | Alta | Aberto | Defesa central anti-brute-force do login é por-instância, não global (M-04) | Médio — store distribuído (Upstash) ou aceitar+documentar | FIN-10 |
