...
| TD-2 | Security Review em falta — transactions-redesign | Alta | Aberto | Feature entregue sem o gate obrigatório de segurança | Baixo — correr o agente | FIN-3 |
...
| TD-4 | Branch protection em main (A1) — required check "Deterministic gate" | Alta | Aberto | Sem ela o CI é informativo: vermelho não bloqueia merge | Mínimo — acção manual do utilizador no GitHub | FIN-5 |
